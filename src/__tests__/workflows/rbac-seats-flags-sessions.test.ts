/**
 * RBAC — Seat Tests (F01–F06), Feature Flag Tests (G01–G09),
...
describe('RBAC — Seat Tests (F01–F06)', () => {
...
describe('RBAC — Feature Flag Tests (G01–G09)', () => {
...
describe('RBAC — Session & Auth Tests (H01–H08)', () => {
...
describe('RBAC — Cross-Cutting Security (X01–X06)', () => {
