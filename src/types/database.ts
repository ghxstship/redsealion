  ...
  public: {
    Tables: {
      ...
      bluesky_accounts: {
        ...
        Relationships: [
          {
            foreignKeyName: "bluesky_accounts_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      compliance_documents: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "compliance_documents_renewed_from_id_fkey"
          ...
          },
          {
            ...
            columns: ["renewed_from_id"]
            isOneToOne: false
            referencedRelation: "v_compliance_expiring_soon"
            referencedColumns: ["id"]
          },
          {
      ...
      creative_references: {
        ...
        Relationships: [
          {
            foreignKeyName: "creative_references_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      milestone_requirements: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "milestone_requirements_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      portfolio_library: {
        ...
        Relationships: [
          {
            foreignKeyName: "portfolio_library_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
      ...
      portfolio_library_tags: {
        ...
        Relationships: [
          {
            foreignKeyName: "portfolio_library_tags_portfolio_id_fkey"
          ...
          {
            foreignKeyName: "portfolio_library_tags_tag_id_fkey"
            columns: ["tag_id"]
            isOneToOne: false
      ...
      proposal_comments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "proposal_comments_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      users: {
        ...
        Relationships: [
          {
            foreignKeyName: "users_facility_uuid_fkey"
            columns: ["facility_uuid"]
            isOneToOne: false
...
// ═══════════════════════════════════════════════════════════════════════════
// MANUAL RE-EXPORT BLOCK — DO NOT DELETE
// This section is manually maintained. `supabase gen types` overwrites
// everything above this line. After regenerating, restore this block.
// ═══════════════════════════════════════════════════════════════════════════
...
// Venues
export type Venue = PublicTables['venues']['Row'];
