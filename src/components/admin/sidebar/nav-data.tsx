...
export const navSections: NavSection[] = [
  ...
  // ─── 2. PROJECTS ────────────────────────────────────────────
  {
    ...
    items: [
      { label: 'Projects', labelKey: 'nav.projects', href: '/app/projects', feature: 'proposals', icon: <IconNavProjects size={18} /> },
  ...
  // ─── 5. OPERATIONS ─────────────────────────────────────────
  {
    ...
    items: [
      ...
      { label: 'Marketplace', labelKey: 'nav.marketplace', href: '/app/marketplace', feature: 'work_orders', icon: <IconNavMarketplace size={18} /> },
