...
const comparisonData: Category[] = [
  {
    ...
    features: [
      ...
      { name: 'Client portal', starter: true, professional: 'With comments', enterprise: 'Full (approvals + files)' },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'QuickBooks/Xero sync', starter: false, professional: true, enterprise: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Resource scheduling', starter: false, professional: false, enterprise: true },
      { name: 'Capacity planning', starter: false, professional: false, enterprise: true },
  ...
  },
  {
    ...
    features: [
      { name: 'CRM sync (Salesforce, HubSpot)', starter: false, professional: true, enterprise: true },
      { name: 'PM sync (ClickUp, Asana)', starter: false, professional: true, enterprise: true },
