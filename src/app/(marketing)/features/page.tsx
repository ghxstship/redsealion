...
export const metadata: Metadata = {
  title: 'Features',
  description:
    'Explore XPB features: interactive proposals, CRM, invoicing, time tracking, resource scheduling, budgeting, profitability, integrations, and AI — built for experiential production.',
};
