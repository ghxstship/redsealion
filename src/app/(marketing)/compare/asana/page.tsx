...
const jsonLd = {
  ...
  '@type': 'WebPage',
  name: 'FlyteDeck vs Asana',
  description: 'See why experiential production teams choose FlyteDeck over Asana.',
  breadcrumb: {
    '@type': 'BreadcrumbList',
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Asana', item: 'https://flytedeck.io/compare/asana' },
    ],
  },
};
    ...
    <>
      ...
      <nav className="px-8 pt-8 lg:px-16" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-sm text-zinc-400">
          ...
          <li>/</li>
          <li className="text-zinc-600">Asana</li>
        </ol>
      </nav>
