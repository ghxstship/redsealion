...
export default async function WorkloadsSchedulePage() {
  ...
  return (
    <TierGate feature="resource_scheduling">
      ...
      >
        <Link href="/app/workloads" className="inline-flex items-center justify-center rounded-lg bg-foreground px-4 py-2 text-sm font-medium text-background hover:opacity-90 transition-opacity">
          New Allocation
        </Link>
      </PageHeader>
