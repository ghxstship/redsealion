...
/**
 * SettingsNav — Client component for settings sidebar navigation.
 *
 * Extracted from the former settings layout to allow the layout itself
 * to be a server component with server-side RBAC gating.
 */
