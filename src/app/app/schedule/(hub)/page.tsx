...
const STATUS_COLORS: Record<string, string> = { draft: 'bg-yellow-50 text-yellow-700', published: 'bg-blue-50 text-blue-700', live: 'bg-green-50 text-green-700', completed: 'bg-gray-50 text-gray-700' };
