/**
 * Harbor Master — Audit Logging
 *
 * Server-side structured audit logging (§13).
 * All events from §13.2 should flow through this module.
 */
import { createClient } from '@/lib/supabase/server';
import type { AuditActorType } from '@/types/harbor-master';
