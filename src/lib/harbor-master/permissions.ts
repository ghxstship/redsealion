/**
 * Harbor Master — Server-Side Permission Resolution
 *
 * Implements the check_permission algorithm from §5.7 of the spec.
 ...
 */
export async function checkHarborPermission(
